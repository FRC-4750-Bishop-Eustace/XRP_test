...
def drive_straight(drive_time: float = 1):
    drivetrain.set_effort(0.8, 0.8, 0.8, 0.8)
    time.sleep(drive_time)
    drivetrain.stop()
    
def reverse(drive_time: float = 1):
    drivetrain.set_effort(-0.8, -0.8, -0.8, -0.8)
    time.sleep(drive_time)
    drivetrain.stop()

def strafe_left(drive_time: float = 1):
    drivetrain.set_effort(0.8, -0.8, -0.8, 0.8)
    time.sleep(drive_time)
    drivetrain.stop()
    
def strafe_right(drive_time: float = 1):
    drivetrain.set_effort(-0.8, 0.8, 0.8, -0.8)
    time.sleep(drive_time)
    drivetrain.stop()
...
def arc_turn(turn_time: float = 1):
    drivetrain.set_effort(0.5, 0.8, 0,5, 0.8)
...
def circle():
    while True:
        drivetrain.set_effort(0.8, 1, 0.8, 1)
